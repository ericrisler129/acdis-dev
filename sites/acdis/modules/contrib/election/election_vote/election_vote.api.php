 ...
 */
function hook_election_vote_before_grant(stdClass $post, stdClass $account) {
 ...
 *   A Drupal user account object.
 */
function hook_election_vote_access_explain_alter(array &$limitations, stdClass $post, stdClass $account) {
 ...
 */
function hook_election_vote_ELECTION_TYPE_save($ballot_id, stdClass $post, array $vote_form, array $vote_form_state) {
 ...
 */
function hook_election_vote_ballot_value_alter(&$value, $election, stdClass $post, stdClass $account) {
